...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        num_of_preprocess_threads = args.num_of_threads
        images_and_labels = []
        for _ in range(num_of_preprocess_threads):
        ...
        image_batch, labels_batch = tf.train.batch_join(
            ...
            capacity=4 * num_of_preprocess_threads * args.batch_size,
...
def parse_arguments(argv):
    ...
    parser.add_argument('--people_per_batch', type=int,
                        help='Number of people per batch.', default=36)
    parser.add_argument('--images_per_person', type=int,
                        help='Number of images per person.', default=32)
    parser.add_argument('--epoch_size', type=int,
                        help='Number of batches per epoch.', default=800)
    ...
    parser.add_argument('--learning_rate_schedule_file', type=str,
                        ...
                        default='config/learning_rate_schedule.txt')

    # Parameters for validation on LFW
    parser.add_argument('--lfw_pairs', type=str,
                        help='The file containing the pairs to use for validation.', default='config/pairs.txt')
